...
export function getAndPassToLocals(req, res, next) {
...
function ensureExistance(req, res, next) {
    var employee = res.locals.employee;
    if (!employee) {
        throw { status: 404, message: "Employee doesn't exist" };
    }
    next();
}
function ensureHasUniqueCardType(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, employeeId, cardType, card;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, employeeId = _a.employeeId, cardType = _a.cardType;
                    return [4 /*yield*/, cardRepository.findByTypeAndEmployeeId(cardType, employeeId)];
                case 1:
                    card = _b.sent();
...
var employee = {
    ...
    ensureHasUniqueCardType: ensureHasUniqueCardType
};
export { employee };
