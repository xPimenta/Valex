...
export function find() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.query("SELECT * FROM cards")];
                case 1:
                    result = _a.sent();
...
export function findById(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.query("SELECT * FROM cards WHERE id=$1", [id])];
                case 1:
                    result = _a.sent();
...
export function findByNumber(number) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.query("SELECT * FROM cards WHERE number=$1", [number])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows[0]];
            }
...
export function findByTypeAndEmployeeId(type, employeeId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.query("SELECT * FROM cards WHERE type=$1 AND \"employeeId\"=$2", [type, employeeId])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows[0]];
            }
...
export function insert(cardData) {
    var employeeId = cardData.employeeId, number = cardData.number, cardholderName = cardData.cardholderName, securityCode = cardData.securityCode, expirationDate = cardData.expirationDate, password = cardData.password, isVirtual = cardData.isVirtual, originalCardId = cardData.originalCardId, isBlocked = cardData.isBlocked, type = cardData.type;
...
export function remove(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            db.query("DELETE FROM cards WHERE id=$1", [id]);
            return [2 /*return*/];
        });
    });
}
